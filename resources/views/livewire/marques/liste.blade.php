          ...
          <div class="col-10">
            <div class="card">
              ...
              <div class="card-header bg-orange">
                <h3 class="card-title"><i class="fas"></i> <b>Liste des Marques</b></h3>

                <div class="card-tools d-flex align-items-center">
                <a class="btn btn-link text-white mr-4 d-block bg-black" wire:click.prevent='goToAddMar()' ><i class="fas fa-plus-circle "></i>Nouvelle Marque </a>
                  ...
                  <tbody>
                   @foreach ($marques as $marque )
                    ...
                    <tr>
                      ...
                      <button class="btn btn-link bg-orange" wire:click.prevent='goToEditMarq({{$marque->id}})'><i class="far fa-edit"></i></button> 
