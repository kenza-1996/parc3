          ...
          <div class="col-9">
            <div class="card">
              ...
              <div class="card-header bg-orange">
                <h3 class="card-title"><i class="fas"></i> <b>Liste des Categories </b></h3>

                <div class="card-tools d-flex align-items-center">
                <a class="btn btn-link text-white mr-4 d-block bg-black" wire:click.prevent='goToAddCat()'><i class="fas fa-plus-circle "></i>Nouvelle Categorie </a>
                  ...
                  <tbody>
                   @foreach ($categories as $categorie )
                    ...
                    <tr>
                      ...
                      <button class="btn btn-link bg-orange" wire:click.prevent='goToEditCat({{$categorie->id}})'><i class="far fa-edit"></i></button> 
