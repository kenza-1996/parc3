       ...
       <div class="col-md-6">
        <div class="card card-orange">
              <div class="card-header">
                <h3 class="card-title"> <i class="fas fa-user-plus fa-2x"></i><b> Formulaire d'edition  utilisateur </b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  <div class="d-flex">
                   ...
                   <div class="form-group ">
                    ...
                    <input type="text" wire:model="editPersonnel.matricule" class="form-control @error('editPersonnel.matricule') is invalide @enderror">
                   ...
                   <div class="form-group ">
                    ...
                    <input type="text" wire:model="editPersonnel.num_bureau" class="form-control @error('editPersonnel.num_bureau') is invalide @enderror">
